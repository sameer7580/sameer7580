...
# Hi, I'm Sameer Kumar Tiwari 👋

### Data Analyst · MIS Executive · Reporting Analyst · Business Analyst
...
`Tableau` `Power BI` `Parameters` `Calculated Fields` `Dashboard Design`
...
`Python` `Pandas` `Matplotlib` `EDA` `Data Cleaning` `Business Reporting`
...
|---|---|---|
| 🥇 Data Analyst Masters Program *(with Distinction)* | Simplilearn | 2026 |
| ☁️ Microsoft Azure Data Analysis | Simplilearn | 2026 |
| 🤖 GenAI Powered Data Analytics Job Simulation | Tata × Forage | 2026 |
| 🐍 Python Refresher with AI | Simplilearn | 2026 |
| 📊 Data Visualisation Fundamentals | Simplilearn | 2025–26 |
...
- 🥇 **KVS Science Exhibition 2019** — 1st Place Regional; represented Delhi at National Level *(LiFi Technology project)*
- 🎙️ **CharkView Debating Society, MAC-DU** (2021–24) — Progressed from Core Member → Senior Core → **Social Media Head**
- ⚽ **Football Team Captain** — Represented college at DU, DTU, Symbiosis & SRCC tournaments

---

## 🌐 Languages

🇬🇧 English — Proficient &nbsp;|&nbsp; 🇮🇳 Hindi — Native &nbsp;|&nbsp; 🇪🇸 Spanish — Elementary
